...
import { idlFactory } from './canistore.did.js';
export { idlFactory } from './canistore.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_CANISTORE;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./canistore.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the canistore canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./canistore.did.js")._SERVICE>}
 */
export const canistore = createActor(canisterId);
